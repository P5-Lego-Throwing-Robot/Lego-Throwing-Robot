...
double goal_position[3] = {0.7, 0.7, -0.3}; // goal position in meters from base frame
...
void throw_to(double position[3]) {
    ...
    // Instantiating a trajectory and adding an acceleration and deceleration phase to is
    ...
    sleep((acceleration_time / velocity) + 0.5);
